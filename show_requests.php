...
$sql = "SELECT H_R_id, h_id, Requested_qnt, H_R_BloodGrp, Fulfill_till FROM tb_H_request";
            ...
            <table>
                ...
                <?php
                    ...
                    while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                        echo "<tr>";
                        echo "<td>" . htmlspecialchars($row['H_R_id']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['h_id']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['Requested_qnt']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['H_R_BloodGrp']) . "</td>";
                        
                        // Display the Fulfill_till date
                        if ($row['Fulfill_till'] instanceof DateTime) {
                            echo "<td>" . htmlspecialchars($row['Fulfill_till']->format('Y-m-d')) . "</td>";
                        } else {
                            echo "<td>" . htmlspecialchars($row['Fulfill_till']) . "</td>";
                        }
